...
@can('楼盘管理')
<li><a href="{{ backpack_url('house') }}"><i class="fa fa-building"></i> <span>楼盘管理</span></a></li>
@endcan

@can('资讯管理')
<li><a href="{{ backpack_url('article') }}"><i class="fa fa-newspaper-o"></i> <span>楼盘资讯</span></a></li>
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li><a href="{{ backpack_url('propertytype') }}"><i class="fa fa-building-o"></i> <span> 物业类型</span></a></li>
